...
export function Navbar({ brand = "DavTek Industries" }){
  ...
  //  possible because everything is handled declaratively. In any case, it is set at
  //  during parts 1 and 4 respectively of opening and closing, and it is read within
  //  toggleCollapse, and used as a flag to conditionally return early if already transitioning.
  //  It's really not needed, but doesn't hurt at all...
  //
  ////////////////////////////////////////////////////////////////////////////////////
  ...
  useEffect(() => {
    ...
    //* Closing Part 1.
      ...
      //  
      //    if (!show && collapseStyle.hasOwnProperty('height')){ ... }
      //
      //
